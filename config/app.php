...
return [
    ...
    */
    'app_setting' => [
        ...
        'color' => env('APP_COLOR', '#e85147'),
        'font_color' => env('APP_FONT_COLOR', '#c52323'),
        'border_color' => env('APP_BORDER_COLOR', '#c0372e'),
        ...
        'ticket_email' => env('TICKET_EMAIL', 'ticket@green-myanmar.com'),
        'phone' => env('APP_PHONE', ''),
        'main_logo' => env('MAIN_LOGO', ''),
        // 'logo' => env('APP_FAVICON', ''),
        'favicon' => env('APP_FAVICON', ''),
        'tnc' => env('APP_TNC', 'Booking Terms & Conditions'),
        'ref' => env('APP_REF', ''),
        'dollar_rate' => env('APP_DOLLAR_RATE', '1050'),
        'map_key' => env('GOOGLE_MAP', ''),
        'date_format' => env('DATE_FORMAT'),
        'time_format' => env('TIME_FORMAT'),
        'date_time_format' => env('DATE_TIME_FORMAT'),
    ...
    'date_time_format_list' => [
        'd-m-Y h:i A' => '31-01-2017 09:15 AM/PM',
        'd-m-Y H:i' => '31-01-2017 21:15',
        'd/m/Y h:i A' => '31/01/2017 09:15 AM/PM',
        'd/m/Y H:i' => '31/01/2017 21:15',
        'F d, Y h:i A' => 'January 31, 2017 09:15 AM/PM',
        'F d, Y H:i' => 'January 31, 2017 21:15',
        'M d, Y h:i A' => 'Jan 31, 2017 09:15 AM/PM',
        'M d, Y H:i' => 'Jan 31, 2017 21:15',
    ],
    /*
    |--------------------------------------------------------------------------
