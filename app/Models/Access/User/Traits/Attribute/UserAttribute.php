...
trait UserAttribute
{
    ...
    public function getActionButtonsAttribute()
    {
     ...
     public function getMemberEditButtonAttribute()
    {
        return '<a href="'.route('admin.access.member.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }

    public function getChangeMemberPasswordButtonAttribute()
    {
        return '<a href="'.route('admin.access.member.change-password', $this).'" class="btn btn-xs btn-info"><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.backend.access.users.change_password').'"></i></a> ';
    }

    public function getDeleteMemberButtonAttribute()
    {
        if ($this->id != access()->id()) {
            return '<a href="'.route('admin.access.member.destroy', $this).'"
                 data-method="delete"
                 data-trans-button-cancel="'.trans('buttons.general.cancel').'"
                 data-trans-button-confirm="'.trans('buttons.general.crud.delete').'"
                 data-trans-title="'.trans('strings.backend.general.are_you_sure').'"
    ...
    public function getShowmemberButtonAttribute()
    {
        return '<a href="'.route('admin.access.member.show', $this).'" class="btn btn-xs btn-info"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.view').'"></i></a> ';
    }

    

    public function getMemberactionButtonsAttribute()
    {
       
        return  $this->getLoginAsButtonAttribute().
                $this->getShowmemberButtonAttribute().
                $this->getMemberEditButtonAttribute().
                $this->getChangeMemberPasswordButtonAttribute().
                $this->getDeleteMemberButtonAttribute();
              
    }

    //for supplier
     public function getSupplierEditButtonAttribute()
    {
        return '<a href="'.route('admin.access.supplier.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }

     public function getShowsupplierButtonAttribute()
    {
        return '<a href="'.route('admin.access.supplier.show', $this).'" class="btn btn-xs btn-info"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.view').'"></i></a> ';
    }

    public function getChangeSupplierPasswordButtonAttribute()
    {
        return '<a href="'.route('admin.access.supplier.change-password', $this).'" class="btn btn-xs btn-info"><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.backend.access.users.change_password').'"></i></a> ';
    }

    public function getDeleteSupplierButtonAttribute()
    {
        if ($this->id != access()->id()) {
            return '<a href="'.route('admin.access.supplier.destroy', $this).'"
                 data-method="delete"
                 data-trans-button-cancel="'.trans('buttons.general.cancel').'"
                 data-trans-button-confirm="'.trans('buttons.general.crud.delete').'"
                 data-trans-title="'.trans('strings.backend.general.are_you_sure').'"
     ...
     public function getSupplieractionButtonsAttribute()
    {
       
        return   $this->getLoginAsButtonAttribute().
                 $this->getShowsupplierButtonAttribute().
                 $this->getSupplierEditButtonAttribute().
                  $this->getChangeSupplierPasswordButtonAttribute().
                 $this->getDeleteSupplierButtonAttribute();
