...
@section ('title', trans('hotel::labels.backend.hotel.management') . ' | ' . trans('hotel::labels.backend.hotel.edit'))

@section('page-header')
    <h1>
        {{ trans('hotel::labels.backend.hotel.management') }}
        <small>{{ trans('hotel::labels.backend.hotel.edit') }}</small>
    </h1>
@endsection
...
@section('content')
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('hotel::labels.backend.hotel.edit') }}</h3>
            ...
            <div class="box-body">
                        ...
                        ?>   
                            ...
                            {{ Form::open(['route' => ['admin.hotel.update', $hotel->id], 'class' => 'form-horizontal', 'role' => 'form', 'files' => true, 'method' => 'PATCH', 'id' => 'edit-hotel']) }}
                            
                             {!! Form::hidden('tab',$tab) !!}

                             <div class="form-group">
                             {{ Form::label('name', trans('hotel::labels.backend.hotel.table.name'), ['class' => 'col-lg-2 control-label']) }}

                                <div class="col-lg-10">
                                {{ Form::text('name', $hotel->name, ['class' => 'form-control', 'placeholder' => trans('hotel::labels.backend.hotel.table.name')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            {{ Form::label('meta_keyword', trans('hotel::labels.backend.hotel.table.meta_keyword'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::textarea('meta_keyword', $hotel->meta_keyword, ['class' => 'form-control', 'placeholder' => trans('hotel::labels.backend.hotel.table.meta_keyword')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            {{ Form::label('meta_description', trans('hotel::labels.backend.hotel.table.meta_description'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::textarea('meta_description', $hotel->meta_description, ['class' => 'form-control', 'placeholder' => trans('hotel::labels.backend.hotel.table.meta_description')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control--> 
                            ...
                            {{ Form::label('phone', trans('hotel::labels.backend.hotel.table.phone'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::text('phone', $hotel->phone, ['class' => 'form-control', 'placeholder' => trans('hotel::labels.backend.hotel.table.phone')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            {{ Form::label('email', trans('hotel::labels.backend.hotel.table.email'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::text('email', $hotel->email, ['class' => 'form-control', 'placeholder' => trans('hotel::labels.backend.hotel.table.email')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            {{ Form::label('address', trans('hotel::labels.backend.hotel.table.address'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::text('address', $hotel->address, ['class' => 'form-control', 'placeholder' => trans('hotel::labels.backend.hotel.table.address')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            {{ Form::label('logo', trans('hotel::labels.backend.hotel.table.logo'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                <img src="{{ url('uploads/'.$hotel->logo) }}" style="width: 100px;height: 100px;">
                                {{ Form::file('logo', '', ['class' => 'form-control', 'placeholder' => trans('hotel::labels.backend.hotel.table.logo')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->

                            <div class="form-group">
                            {{ Form::label('hotel_category_id', trans('hotel::labels.backend.hotel.table.hotel_category'), ['class' => 'col-lg-2 control-label']) }}

                                <div class="col-lg-10">
                                <select class='form-control select2' name='hotel_category_id' autofocus="true">
                                    @foreach($hotel_categories as $hotel_category)
                                        @if($hotel_category->id == $hotel->hotel_category_id)
                            ...
                            {{ Form::label('class', trans('hotel::labels.backend.hotel.table.class'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::text('class', $hotel->class, ['class' => 'form-control', 'placeholder' => trans('hotel::labels.backend.hotel.table.class')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <div class="form-group">
                            {{ Form::label('description', trans('hotel::labels.backend.hotel.table.description'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('description', $hotel->description, ['class' => 'form-control editor', 'placeholder' => trans('hotel::labels.backend.hotel.table.description')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                                    ...
                                    <div class="tab-pane {{ ($tab=='location')?'active':'' }}" id="location">
                                        <div class="col-md-offset-1">
                                            ...
                                            <br>{{ Form::label('city_id', trans('hotel::labels.backend.hotel.table.city'), ['class' => 'col-lg-1 ']) }}
                                                <div class="col-lg-10">
                                                <select class='form-control select2' name='city_id' autofocus="true">
                                            ...
                                            {{ Form::label('latitude', trans('hotel::labels.backend.hotel.table.latitude'), ['class' => 'col-lg-1 ']) }}
                                                ...
                                                <div class="col-lg-10">
                                                {{ Form::text('latitude', $hotel->latitude, ['class' => 'form-control','id'=>'input-latitude', 'placeholder' => trans('hotel::labels.backend.hotel.table.latitude')]) }}
                                                </div><!--col-lg-10-->
                                            </div><!--form control-->
                                            ...
                                            {{ Form::label('longitude', trans('hotel::labels.backend.hotel.table.longitude'), ['class' => 'col-lg-1 ']) }}
                                                ...
                                                <div class="col-lg-10">
                                                {{ Form::text('longitude', $hotel->longitude, ['class' => 'form-control','id'=>'input-longitude', 'placeholder' => trans('hotel::labels.backend.hotel.table.longitude')]) }}
                                                </div><!--col-lg-10-->
                                            </div><!--form control-->
                                        </div>
                                    </div><!-- tab-pane -->
                                        ...
                                        <div class="col-md-offset-1">
                                            <div class="form-group">                                          
                                                @foreach($amenities as $amenity)
                                                    <div class="col-lg-3">                               
                                                        <input type="checkbox" value="{{ $amenity->id }}" id="{{$amenity->name}}" name="amenity_id[]" @if(in_array($amenity->id,$hotel_amenities_id)) checked @endif>
...
<script src="/js/backend/plugin/bootstrap-summernote/summernote.min.js"></script>
    <script type="text/javascript">
        ...
        function initMap() {
            ...
            var marker_position = new google.maps.LatLng({{$hotel->latitude}}, {{$hotel->longitude}});
