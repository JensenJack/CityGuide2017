...
@section ('title', trans('sms::labels.backend.sms.management') . ' | ' . trans('sms::labels.backend.sms.create'))

@section('page-header')
    <h1>
        {{ trans('sms::labels.backend.sms.management') }}
        <small>{{ trans('sms::labels.backend.sms.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.sms.store', 'class' => 'form-horizontal', 'files' => true ,'role' => 'form', 'method' => 'post', 'id' => 'create-sms']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('sms::labels.backend.sms.create') }}</h3>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('slug', null, ['class' => 'form-control', 'placeholder' => trans('sms::labels.backend.sms.table.slug')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                <div class="form-group">
