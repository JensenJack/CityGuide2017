...
@section ('title', trans('city::labels.backend.city.management') . ' | ' . trans('city::labels.backend.city.create'))

@section('page-header')
    <h1>
        {{ trans('city::labels.backend.city.management') }}
        <small>{{ trans('city::labels.backend.city.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.city.store', 'class' => 'form-horizontal', 'files' => true ,'role' => 'form', 'method' => 'post', 'id' => 'create-city']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('city::labels.backend.city.create') }}</h3>
