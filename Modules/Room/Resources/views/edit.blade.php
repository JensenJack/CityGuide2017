...
@section ('title', trans('room::labels.backend.room.management') . ' | ' . trans('room::labels.backend.room.edit'))

@section('page-header')
    <h1>
        {{ trans('room::labels.backend.room.management') }}
        <small>{{ trans('room::labels.backend.room.edit') }}</small>
    </h1>
@endsection
...
@section('content')
        <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ trans('room::labels.backend.room.edit') }}</h3>
                    ...
                    <div class="box-body">
                        ...
                        ?>   
                            ...
                            {{ Form::open(['route' => ['admin.room.update', $room->id], 'class' => 'form-horizontal', 'role' => 'form', 'files' => true, 'method' => 'PATCH', 'id' => 'edit-room']) }}
                             ...
                             {{ Form::label('name', trans('room::labels.backend.room.table.name'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::text('name', $room->name, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.name')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            {{ Form::label('meta_keyword', trans('room::labels.backend.room.table.meta_keyword'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::textarea('meta_keyword', $room->meta_keyword, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.meta_keyword')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            {{ Form::label('meta_description', trans('room::labels.backend.room.table.meta_description'), ['class' => 'col-lg-2 control-label']) }}
                                ...
                                <div class="col-lg-10">
                                {{ Form::textarea('meta_description', $room->meta_description, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.meta_description')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control--> 
                                ...
                                <div class="col-lg-10">
                                    <select class='form-control select2' name='room_category_id'>
                                        ...
                                        @foreach($room_categories as $room_category)
                                            @if($room_category->id == $room->room_category_id)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('description', $room->description, ['class' => 'form-control editor', 'placeholder' => trans('room::labels.backend.room.table.description')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('quantity', $room->quantity, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.quantity')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('minimum_stay', $room->minimum_stay, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.minimum_stay')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('max_adults', $room->max_adults, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.max_adults')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('extra_bed', $room->extra_bed, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.extra_bed')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('extra_bed_charge', $room->extra_bed_charge, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.extra_bed_charge')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane {{ ($tab=='prices')?'active':'' }}" id="prices">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    {{ Form::text('local_buy_price', $room->local_buy_price, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.local_buy_price')]) }}
                                                </div><!--col-lg-10-->
                                            </div><!--form control-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    {{ Form::text('local_sell_price', $room->local_sell_price, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.local_sell_price')]) }}
                                                </div><!--col-lg-10-->
                                            </div><!--form control-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    {{ Form::text('foreign_buy_price', $room->foreign_buy_price, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.foreign_buy_price')]) }}
                                                </div><!--col-lg-10-->
                                            </div><!--form control-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    {{ Form::text('foreign_sell_price', $room->foreign_sell_price, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.foreign_sell_price')]) }}
                                                </div><!--col-lg-10-->
                                            </div><!--form control-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    {{ Form::text('agent_buy_price', $room->agent_buy_price, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.agent_buy_price')]) }}
                                                </div><!--col-lg-10-->
                                            </div><!--form control-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    {{ Form::text('agent_sell_price', $room->agent_sell_price, ['class' => 'form-control', 'placeholder' => trans('room::labels.backend.room.table.agent_sell_price')]) }}
                                                </div><!--col-lg-10-->
                                            </div><!--form control-->
                                        </div> <!-- tab-pane -->
                                            ...
                                            <div class="col-md-offset-1">
                                                <div class="form-group">         
                                                    @foreach($amenities as $amenity)
                                                        <div class="col-lg-3">                                                 
                                                            <input type="checkbox" value="{{ $amenity->id }}" id="{{$amenity->name}}" name="amenity_id[]" @if(in_array($amenity->id,$room_amenities_id)) checked @endif>
