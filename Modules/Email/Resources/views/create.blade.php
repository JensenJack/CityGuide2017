...
@section ('title', trans('email::labels.backend.email.management') . ' | ' . trans('email::labels.backend.email.create'))

@section('page-header')
    <h1>
        {{ trans('email::labels.backend.email.management') }}
        <small>{{ trans('email::labels.backend.email.create') }}</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::open(['route' => 'admin.email.store', 'class' => 'form-horizontal', 'files' => true ,'role' => 'form', 'method' => 'post', 'id' => 'create-email']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('email::labels.backend.email.create') }}</h3>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('slug', null, ['class' => 'form-control', 'placeholder' => trans('email::labels.backend.email.table.slug')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                <div class="form-group">
                ...
                </div><!--form control--><div class="form-group">
