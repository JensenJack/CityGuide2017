...
@section ('title', trans('hotelcategory::labels.backend.hotelcategory.management') . ' | ' . trans('hotelcategory::labels.backend.hotelcategory.edit'))

@section('page-header')
    <h1>
        {{ trans('hotelcategory::labels.backend.hotelcategory.management') }}
        <small>{{ trans('hotelcategory::labels.backend.hotelcategory.edit') }}</small>
    </h1>
@endsection

@section('content')

    {{ Form::model($hotelcategory, ['route' => ['admin.hotelcategory.update', $hotelcategory], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-hotelcategory']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('hotelcategory::labels.backend.hotelcategory.edit') }}</h3>
