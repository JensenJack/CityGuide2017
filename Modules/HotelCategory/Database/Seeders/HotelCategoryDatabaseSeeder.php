...
namespace Modules\HotelCategory\Database\Seeders;

use Carbon\Carbon as Carbon;
use Illuminate\Database\Seeder;
use Illuminate\Database\Eloquent\Model;

class HotelCategoryDatabaseSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $module = strtolower('HotelCategory');
        $permission_model = config('access.permission');
        $view_permission = new $permission_model();
        $view_permission->name = 'view-'.$module;
        $view_permission->display_name = 'View Hotel Category';
        ...
        $create_permission->display_name = 'Create Hotel Category';
        ...
        $edit_permission->display_name = 'Edit Hotel Category';
        ...
        $delete_permission->display_name = 'Delete Hotel Category';
