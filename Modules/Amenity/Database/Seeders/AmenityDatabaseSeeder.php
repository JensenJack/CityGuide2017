...
class AmenityDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $create_permission->display_name = 'Create Amenity';
        ...
        $edit_permission->display_name = 'Edit Amenity';
        ...
        $delete_permission->display_name = 'Delete Amenity';
