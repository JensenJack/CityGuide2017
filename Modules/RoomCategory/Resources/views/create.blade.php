...
@section ('title', trans('roomcategory::labels.backend.roomcategory.management') . ' | ' . trans('roomcategory::labels.backend.roomcategory.create'))

@section('page-header')
    <h1>
        {{ trans('roomcategory::labels.backend.roomcategory.management') }}
        <small>{{ trans('roomcategory::labels.backend.roomcategory.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.roomcategory.store', 'class' => 'form-horizontal', 'files' => true ,'role' => 'form', 'method' => 'post', 'id' => 'create-roomcategory']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('roomcategory::labels.backend.roomcategory.create') }}</h3>
