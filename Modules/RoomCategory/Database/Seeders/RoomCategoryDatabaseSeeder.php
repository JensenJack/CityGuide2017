...
namespace Modules\RoomCategory\Database\Seeders;
use Carbon\Carbon as Carbon;
use Illuminate\Database\Seeder;
use Illuminate\Database\Eloquent\Model;

class RoomCategoryDatabaseSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $module = strtolower('RoomCategory');
        $permission_model = config('access.permission');
        $view_permission = new $permission_model();
        $view_permission->name = 'view-'.$module;
        $view_permission->display_name = 'View Room Category';
        ...
        $create_permission->display_name = 'Create Room Category';
        ...
        $edit_permission->display_name = 'Edit Room Category';
        ...
        $delete_permission->display_name = 'Delete Room Category';
