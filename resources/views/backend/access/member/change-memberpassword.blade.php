...
@section ('title', trans('labels.backend.access.members.management') . ' | ' . trans('labels.backend.access.users.change_password'))
...
@section('content')
    ...
    {{ Form::open(['route' => ['admin.access.member.change-password', $user], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'patch']) }}
