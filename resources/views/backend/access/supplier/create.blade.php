...
@section ('title', trans('labels.backend.access.suppliers.management') . ' | ' . trans('labels.backend.access.suppliers.create'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.access.suppliers.management') }}
        <small>{{ trans('labels.backend.access.suppliers.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.access.supplier.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-supplier']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.access.suppliers.create') }}</h3>
