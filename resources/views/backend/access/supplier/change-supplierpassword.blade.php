...
@section ('title', trans('labels.backend.access.suppliers.management') . ' | ' . trans('labels.backend.access.users.change_password'))
...
@section('content')
    ...
    {{ Form::open(['route' => ['admin.access.supplier.change-password', $user], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'patch']) }}
