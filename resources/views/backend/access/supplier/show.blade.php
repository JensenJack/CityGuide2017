...
@section ('title', trans('labels.backend.access.suppliers.management') . ' | ' . trans('labels.backend.access.suppliers.view'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.access.suppliers.management') }}
        <small>{{ trans('labels.backend.access.suppliers.view') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.access.suppliers.view') }}</h3>
